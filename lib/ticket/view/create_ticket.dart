...
class CreateTicket extends StatefulWidget {
  ...
  const CreateTicket({super.key, this.bookingId});
...
class _CreateTicketState extends State<CreateTicket> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<AllTicketController>(
      init: AllTicketController(bookingId: widget.bookingId),
      builder: (controller) {
        return Scaffold(
          appBar: AppBar(
            leading: BackButton(
                  ...
                  GestureDetector(
                    onTap: () async {
                      if (controller.bookingId == "") {
                        RIEWidgets.getToast(
                            message: 'No booking Found so we can not Create ticket.', color: CustomTheme.white);
                        return;
                      }
                      ...
                      if (controller.ticketDescription.text.isEmpty) {
                        RIEWidgets.getToast(
