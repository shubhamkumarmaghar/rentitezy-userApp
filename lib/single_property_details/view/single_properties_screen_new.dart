...
import 'package:rentitezy/single_property_details/model/single_property_details_model.dart';
...
class _PropertiesDetailsPageNew extends State<PropertiesDetailsPageNew> {
  SinglePropertyDetailsController singlePropertyDetailsController = Get.put(SinglePropertyDetailsController(),permanent: false);
                    ...
                    SingleChildScrollView(
                        ...
                        child: Column(
                          children: [
                                  ...
                                  if (availFrom != null) {
                                    ...
                                    await showDatePicker(
                                      ...
                                      if (pickedDate != null &&
                                        ...
                                        setState(
                                            () => singlePropertyDetailsController.currentDate = pickedDate);
                                      }
                                    });
                                  } else {
                                    await showDatePicker(
                                ...
                                child: Row(
                                  children: [
                                    Expanded(
                                      ...
                                      child: getCustomText(
                                          DateFormat.yMMMd()
                                              .format(singlePropertyDetailsController.currentDate),
                            ...
                            GestureDetector(
                              onTap: () async {
                                if (singlePropertyDetailsController.userId == 'null' || singlePropertyDetailsController.userId == 'guest') {
                                  RIEWidgets.getToast(message: 'You are not ${AppUrls.appName} user. Please Login/Register', color: CustomTheme.white);
                                } else if (singlePropertyDetailsController.dropdownValueGuest == null ||
                                  ...
                                  if (int.parse(singlePropertyDetailsController.dropdownValueGuest.toString()) >
                                      1) {
                                    alertDialog(
                                        context,
                                        'Booking Alert',
      ...
      builder: (controller) {
        ...
        controller.singleProPerty!.data!.images!.length  > 1
                                    ? ScrollPageView(
                                        ...
                                        children: images!.map((image) => _imageView('${image.url}'))
            .toList(),
        )
                                    ...
                                    Container(
                                      ...
                                      child: GoogleMap(
                                          ...
                                          initialCameraPosition: CameraPosition(
                                              target: data!.property?.latlng ==
                                                      'undefined,undefined'
                                                  ? const LatLng(0.0, 0.0)
                                                  : LatLng(
                                                      double.parse('${data!.property?.latlng}'
                                                          .split(',')[0]),
                                                      double.parse('${data!.property?.
                                                          latlng}'
                                                          .split(',')[1])),
                                              zoom: 13.0,
                                              tilt: 0,
